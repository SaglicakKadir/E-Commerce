...
namespace ecommerce.Areas.Admin.Controllers
{
    ...
    public class ItemStatusController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.ItemsStatus.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(short? id)
        {
            ...
            var itemStatus = await _context.ItemsStatus
        ...
        public async Task<IActionResult> Edit(short? id)
        {
            ...
            var itemStatus = await _context.ItemsStatus.FindAsync(id);
            if (itemStatus == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(short id)
        {
            ...
            var itemStatus = await _context.ItemsStatus.FindAsync(id);
            _context.ItemsStatus.Remove(itemStatus);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.ItemsStatus.Any(e => e.ItemStatusId == id);
        }
    }
}
